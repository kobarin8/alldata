...
// getProductInfoListByCategoryId(int categoryId, int productId, int limitOffset,int limitRowCount)
// getProductInfoListAll(String[] keywordsList)
// getProductInfoListByKeywords(String[] keywordsList, String categoryId)
